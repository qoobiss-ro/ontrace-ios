Pod::Spec.new do |spec|
    ...
    spec.vendored_frameworks = ['**/Framework/QoobissCoreIdentificationSDK.xcframework', '**/Framework/Lottie.xcframework', '**/Framework/NFCSDK.xcframework','**/Framework/OpenSSL.xcframework']
